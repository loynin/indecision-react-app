...
var AddOption = function (_React$Component2) {
    ...
    _createClass(AddOption, [{
        ...
        value: function handleAddOption(e) {
            e.preventDefault();
            var strInput = e.target.txtOptionText.value.trim();
            var error = this.props.handleAddOption(strInput);
            this.setState(function () {
                return {
                    error: error
                };
        ...
        value: function render() {
            return React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement('input', { type: 'text', name: 'txtOptionText', autoFocus: true }),
                    React.createElement(
                        'button',
                        null,
                        'Add Option'
